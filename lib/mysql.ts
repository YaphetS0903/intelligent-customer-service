...
async function createSchema(db: mysql.Pool) {
  const statements = [
    ...
    `create table if not exists training_jobs (
      ...
      quiz_pass_score int not null default 80,
      quiz_max_attempts int not null default 3,
      quiz_time_limit_minutes int not null default 30,
    ...
    `create table if not exists training_exam_sessions (
      id varchar(128) primary key,
      training_job_id varchar(128) not null,
      user_id varchar(128) not null,
