...
const adminNavItems = [
  ...
  { href: "/admin", label: "知识管理", icon: Database },
  { href: "/admin/documents", label: "资料治理", icon: FileText },
  ...
  { href: "/admin/analytics", label: "运营看板", icon: BarChart3 },
  { href: "/admin/insights", label: "运营与审计", icon: BarChart3 },
